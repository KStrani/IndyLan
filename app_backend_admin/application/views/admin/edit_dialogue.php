												...
												<div class="card contain_box mrgt10">
													...
													<div class="col-md-2 mrgt10">
														...
														<?php 
																	...
																	$aname = $v['audio_name'];
																	 ?>
																	<?php  $file1 = base_url().'uploads/audio/'.$edit_data[0]['category_id'].'/'.$edit_data[0]['subcategory_id'].'/'.$aname; ?>
																	<?php   $fileaudio =$root_path.'/uploads/audio/'.$edit_data[0]['category_id'].'/'.$edit_data[0]['subcategory_id'].'/'.$aname;?>
