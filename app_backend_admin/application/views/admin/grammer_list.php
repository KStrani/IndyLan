								...
								<form action="<?php echo base_url(); ?>admin_master/grammar_import" method="post" name="upload_excel" enctype="multipart/form-data" onsubmit="return checkvalid();" >
									<div class="form-group row">
										 <div class="col-md-2 col-sm-4 col-xs-12 mrgt5">
											<select id="lang" name="lang" class="form-control grammer_source_lang">
										...
										<div class="col-md-1 col-sm-3 col-xs-5 mrgt5">
											<a href="<?php echo base_url();?>admin_master/excel_export_grammer/<?php echo $lang; ?>/<?php echo $category_select; ?>/<?php echo $subcategory_select; ?>" class="btn btn-primary">Export</a>
										</div>
									</div>
								</form>
...
<script type="text/javascript">
	...
	// $(document).on("change",".grammer_source_lang", function(){
	// 	var lang = $(this).val();
	// 	var sort= $('#sort').val();
	// 	var category= $('#category').val();
	// 	var subcate= $('#subcate').val();
	...
	var category= $('#category').val();
	var lang= $(".grammer_source_lang").val();
	var sort= $('#sort').val();
	...
	//var subcate = this.value;
	var subcate= "";
	var lang= $('.grammer_source_lang').children("option:selected").val();
	...
	var sort= $('#sort').val();
			...
			$.ajax({
					...
					type:'POST',
					data:{cate_id:cate_id, lang:lang},
					success:function(data){
						//$('#category').html("");
						//alert('here');
