							...
							<div class="card-body">
								...
								<form action="<?php echo base_url(); ?>admin_master/phrases_import" method="post" name="upload_excel" enctype="multipart/form-data" onsubmit="return checkvalid();">
									<div class="form-group row">
										...
										<div class="col-md-1 col-sm-3 col-xs-5 mrgt5">
											<a href="<?php echo base_url();?>admin_master/excel_export_phrase/<?php echo $category_select; ?>/<?php echo $subcategory_select; ?>" class="btn btn-primary">Export</a>
										</div>
									</div>
								</form>
													...
													<tbody >
														...
														<tr>
															...
															<td><?php echo ucfirst($key['phrase_'.$langkey['language_code']]); ?>
																	<?php if($langkey['source_language_id']== $target_lang_id){ ?>
