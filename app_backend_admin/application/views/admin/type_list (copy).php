											...
											<table id="datatable1" class="table hover">
												...
												<tbody>
													...
													<tr>
														...
														<td><img src="<?php echo base_url(); ?>uploads/user_profile/<?php echo $key['profile_pic']; ?>" class="img-responsive" width="60px" onerror="this.onerror=null;this.src='<?php echo base_url(); ?>assets/thumb_image_not_available.png';"/></td>
