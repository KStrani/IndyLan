								...
								<form action="<?php echo base_url(); ?>admin_master/culture_import" method="post" name="upload_excel" enctype="multipart/form-data" onsubmit="return checkvalid();" >
									<div class="form-group row">
										 <div class="col-md-2 col-sm-4 col-xs-12 mrgt5">
											<select id="lang" name="lang" class="form-control culture_source_lang">
												<option value="">Select Language</option>
												<?php foreach($master_lang as $key)
													{
										...
										<div class="col-md-1 col-sm-3 col-xs-5 mrgt5">
											<a href="<?php echo base_url();?>admin_master/excel_export_culture/<?php echo $lang; ?>/<?php echo $category_select; ?>/<?php echo $subcategory_select; ?>" class="btn btn-primary">Export</a>
										</div>
									</div>
								</form>
...
<script type="text/javascript">
	...
	// $(document).on("change",".culture_source_lang", function(){
	// 	var lang = $(this).val();
	// 	var sort= $('#sort').val();
	...
	$(document).on("change","#subcate", function()
	{
		...
		var lang= $('.culture_source_lang option:selected').val();
		var sort= $('#sort').val();
		$.ajax({
