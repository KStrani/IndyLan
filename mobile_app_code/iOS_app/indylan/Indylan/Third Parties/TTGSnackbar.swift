...
open class TTGSnackbar: UIView {
    ...
    @objc open dynamic var bottomMargin: CGFloat = 10 {
        didSet {
    ...
    @objc open dynamic var leftMargin: CGFloat = 20 {
        didSet {
    ...
    @objc open dynamic var rightMargin: CGFloat = 20 {
        didSet {
    ...
    /// Content inset. Default is (8, 8, 8, 8)
    @objc open dynamic var contentInset: UIEdgeInsets = UIEdgeInsets.init(top: 8, left: 12, bottom: 8, right: 12) {
        didSet {
    ...
    @objc open dynamic var messageTextFont: UIFont = Fonts.centuryGothic(ofType: .bold, withSize: 14) {
        didSet {
